...
export const GLOBAL_TOURISM_FEATURES: GlobalTourismFeature[] = [
  {
    ...
    implemented: true,
    description: "Consulta por intención y contexto en lenguaje natural.",
  },
  {
    id: "f2",
    name: "Mapa interactivo",
    implemented: true,
    description: "Exploración visual de zonas, POIs y capas temáticas.",
  },
  {
    id: "f3",
    name: "Storytelling multimedia",
    implemented: true,
    description: "Narrativas visuales por secciones culturales.",
  },
  {
    id: "f4",
    name: "Navegación one-page",
    implemented: true,
    description: "Transiciones suaves entre verticales turísticas.",
  },
  {
    id: "f5",
    name: "Recomendación híbrida IA",
    implemented: true,
    description: "Ranking por afinidad, distancia, horario y tendencia.",
  },
  {
    id: "f6",
    name: "Segmentación por intención",
    implemented: true,
    description: "Rutas para gastronomía, historia, cultura, aventura y hospedaje.",
  },
  {
    id: "f7",
    name: "Diseño mobile-first",
    implemented: true,
    description: "UI adaptable para viajeros en movimiento.",
  },
  {
    id: "f8",
    name: "Panel operativo",
    implemented: true,
    description: "Visualización de telemetría y estado del sistema.",
  },
  {
    id: "f9",
    name: "SSE en tiempo real",
    implemented: true,
    description: "Flujos de decisión con heartbeat y reconexión.",
  },
  {
    id: "f10",
    name: "Componentes accesibles",
    implemented: true,
    description: "Base UI con primitives enfocadas en accesibilidad.",
  },
  {
    id: "f11",
    name: "Itinerarios colaborativos",
    implemented: false,
    description: "Guardado y edición compartida de rutas entre viajeros.",
  },
  {
    id: "f12",
    name: "Price tracking",
    implemented: false,
    description: "Alertas de variación de tarifas de hospedaje y tours.",
  },
  {
    id: "f13",
    name: "Comparador inteligente",
    implemented: false,
    description: "Comparativa de costos, tiempos y valor cultural.",
  },
  {
    id: "f14",
    name: "Reserva integrada",
    implemented: false,
    description: "Checkout unificado para actividades y hospedaje.",
  },
  {
    id: "f15",
    name: "Reseñas verificadas",
    implemented: false,
    description: "Valoración con trazabilidad y anti-fraude.",
  },
  {
    id: "f16",
    name: "Rutas offline",
    implemented: false,
    description: "Modo sin conexión para mapa e itinerarios.",
  },
  {
    id: "f17",
    name: "Audio-guías inmersivas",
    implemented: false,
    description: "Narración geolocalizada y activación por proximidad.",
  },
  {
    id: "f18",
    name: "Traductor contextual",
    implemented: false,
    description: "Asistente multi-idioma en puntos clave del recorrido.",
  },
  {
    id: "f19",
    name: "AR patrimonial",
    implemented: false,
    description: "Reconstrucción histórica de espacios mineros y urbanos.",
  },
  {
    id: "f20",
    name: "Asistente de accesibilidad",
    implemented: false,
    description: "Filtros por movilidad reducida y necesidades sensoriales.",
  },
  {
    id: "f21",
    name: "Clima hiperlocal",
    implemented: false,
    description: "Pronóstico de microzonas para planear actividades.",
  },
  {
    id: "f22",
    name: "Detección de saturación",
    implemented: false,
    description: "Alertas de aforo para redistribuir visitantes.",
  },
  {
    id: "f23",
    name: "Gamificación territorial",
    implemented: false,
    description: "Misiones culturales con recompensas locales.",
  },
  {
    id: "f24",
    name: "Wallet turístico",
    implemented: false,
    description: "Pases, cupones y beneficios por fidelidad.",
  },
  {
    id: "f25",
    name: "Recomendación romántica",
    implemented: true,
    description: "Sugerencias para atardeceres, cenas y caminatas íntimas.",
  },
  {
    id: "f26",
    name: "Métricas de sostenibilidad",
    implemented: false,
    description: "Huella de visita y consumo responsable.",
  },
  {
    id: "f27",
    name: "Detección de sesgo",
    implemented: false,
    description: "Monitoreo de fairness en ranking y exposición de negocios.",
  },
  {
    id: "f28",
    name: "Orquestación edge",
    implemented: false,
    description: "Respuestas de baja latencia en nodos distribuidos.",
  },
  {
    id: "f29",
    name: "Motor de eventos",
    implemented: true,
    description: "Registro de interacción cívico-turística para inteligencia operativa.",
  },
  {
    id: "f30",
    name: "Checklist producción",
    implemented: true,
    description: "Ruta de cierre de módulos con validación pre-deploy.",
  },
];
