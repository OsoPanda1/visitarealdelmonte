      ...
      <main className="pt-24 pb-8">
        <section className="max-w-7xl mx-auto px-4 md:px-8 relative overflow-hidden">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at top, hsl(var(--rdm-amber) / 0.15) 0%, transparent 58%)",
            }}
          />
          <motion.div
          ...
          >
            ...
            <h1
              className="text-4xl md:text-6xl font-semibold leading-[0.95]"
              style={{ fontFamily: "var(--font-display)" }}
            >
              {title}
            </h1>
            <p
              className="mt-5 text-lg text-[hsl(215_13%_42%)] max-w-2xl"
            ...
            >
              <Card className="rdm-glass h-full border-0">
                <CardHeader className="pb-2">
                  <CardTitle
                    className="text-sm tracking-[0.14em] uppercase text-[hsl(215_13%_42%)]"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Módulo {index + 1}
                  </CardTitle>
                ...
                <CardContent>
                  <p
                    className="text-sm text-[hsl(215_13%_42%)] leading-relaxed"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {bullet}
                  </p>
