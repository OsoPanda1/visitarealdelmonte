...
const timeline = [
  {
    ...
    description:
      "Exploradores españoles inician expediciones a la Sierra de Pachuca, atraídos por rumores de ricos yacimientos de plata en tierras otomíes.",
    icon: Compass,
    color: "bg-stone",
    details:
      "Las primeras expediciones fueron lideradas por conquistadores que escucharon relatos de los indígenas sobre montañas brillantes. Sin embargo, la topografía montañosa y la resistencia de los pueblos originales dificultaron el establecimiento inicial.",
  },
  {
    year: "1560",
    title: "Descubrimiento de la Veta Madre",
    description:
      "Juan de Zúñiga y Juan de la Cruz descubren la veta madre de plata en la Sierra de Pachuca, dando origen al Real de Minas de Pachuca y el nacimiento oficial de la comunidad minera.",
    icon: Gem,
    color: "bg-terracotta",
    details:
      "El descubrimiento ocurrió en lo que hoy se conoce como Mina de San Antonio. La veta se extendía por kilómetros bajo la montaña, prometiendo riquezas incalculables. La Corona Española inmediatamente estableció el Real de Minas, un distrito minero con privilegios especiales.",
  },
  {
    year: "1580",
    title: "Fundación del Real de Minas",
    description:
      "Se establece oficialmente el Real de Minas con la construcción de las primeras haciendas de beneficio y el trazado de las calles principales siguiendo el modelo colonial español.",
    icon: Building2,
    color: "bg-primary",
    details:
      "La fundación trajo consigo la construcción de la Iglesia de la Asunción, las primeras viviendas para mineros y las haciendas de beneficio donde se procesaba el mineral. La población comenzó a crecer rápidamente, atrayendo trabajadores de todo el centro de México.",
  },
  {
    year: "1766",
    title: "La Llegada de los Cornish",
    description:
      "Inmigrantes de Cornualles, Inglaterra llegan a Real del Monte trayendo tecnología minera revolucionaria, steam engines, y una cultura que transformaría para siempre al pueblo.",
    icon: Ship,
    color: "bg-gold",
    details:
      "Bajo el mando de empresarios como John Rule y James Vetch, llegaron más de 150 familias cornish entre 1824 y 1840. Trajeron consigo bombas de vapor, trenes de mina, herramientas especializadas y conocimientos avanzados de ingeniería. También construyeron la primera estación de ferrocarril en México.",
  },
  {
    year: "1824",
    title: "Independencia Económica",
    description:
      "Pedro Romero de Terreros compra las minas a la Corona Española, marcando el inicio de la minería independiente mexicana y una nueva era de prosperidad.",
    icon: Crown,
    color: "bg-forest",
    details:
      "Romero de Terreros, descendiente de la nobleza española pero mexicano de nacimiento, invirtió fortunas en modernizar las operaciones mineras. Bajo su administración, las minas alcanzaron niveles de producción nunca antes vistos, financiando proyectos de infraestructura en toda la región.",
  },
  {
    year: "1850",
    title: "La Revolución del Paste",
    description:
      "Las pastelerías cornish-mexicanas se establecen formalmente, fusionando la receta del Cornish Pasty con ingredientes locales como el mole, frijol y chile, creando un ícono gastronómico único.",
    icon: Flame,
    color: "bg-terracotta",
    details:
      "Las esposas de los mineros ingleses comenzaron a preparar pasties para sus maridos, pero pronto las cocineras mexicanas adaptaron la receta con sabores locales. Así nació el paste mexicano, una fusión culinaria que solo existe en Real del Monte.",
  },
  {
    year: "1900",
    title: "El Panteón Inglés",
    description:
      "Se consagra el Cementerio de los Anglicanos, hoy conocido como Panteón Inglés, el cementerio anglicano más alto del mundo a 2,700 metros sobre el nivel del mar.",
    icon: Landmark,
    color: "bg-stone",
    details:
      "El Panteón Inglés alberga tumbas que datan desde 1830 hasta 1960. Sus lápidas de mármol cuentan historias de amor, tragedia y aventura. Es el único cementerio en México donde se practican servicios anglicanos regulares y representa la memoria histórica de la comunidad cornish.",
  },
  {
    year: "1930",
    title: "Era de la Nacionalización",
    description:
      "Las minas pasan a manos del gobierno mexicano. El auge minero declina, pero la comunidad encuentra nuevas formas de subsistencia preservando su patrimonio cultural.",
    icon: Scale,
    color: "bg-primary",
    details:
      "La nacionalización de la minería por parte del gobierno federal marcó el fin de una era. Muchas familias emigraron, pero las que se quedaron comenzaron a preservar conscientemente su patrimonio único. Se fundaron los primeros museos y comenzó el turismo cultural.",
  },
  {
    year: "2004",
    title: "Nombramiento Pueblo Mágico",
    description:
      "Real del Monte es nombrado Pueblo Mágico por la Secretaría de Turismo, reconociendo su importancia histórica, cultural y arquitectónica única en México.",
    icon: Sparkles,
    color: "bg-gold",
    details:
      "El nombramiento de Pueblo Mágico vino acompañado de inversiones en infraestructura turística, restauración del centro histórico y programas de preservación cultural. Real del Monte se convirtió en destino internacional, atrayendo a visitantes de todo el mundo.",
  },
  {
    year: "2024",
    title: "Bicentenario Cornish-Mexicano",
    description:
      "Celebración de 200 años de relación cultural entre Cornualles y Real del Monte, con eventos internacionales, intercambios culturales y el fortalecimiento de los lazos históricos.",
    icon: Anchor,
    color: "bg-forest",
    details:
      "El bicentenario marcó el retorno de descendientes de las familias cornish originales, la inauguración de nuevos espacios museísticos, y la consolidación de Real del Monte como un caso único de diáspora cultural en América Latina.",
  },
];
...
const heritageSections = [
  {
    ...
    description:
      "Real del Monte fue el distrito minero más importante de la Nueva España durante tres siglos. Las minas de Acosta, Dificultad, San Cayetano y Dolores produjeron toneladas de plata que financiaron guerras, construyeron naciones y atrajeron a aventureros de todo el mundo.",
...
La plata de Real del Monte financió la Independencia de México, pagó deudas internacionales, y contribuyó al desarrollo de infraestructura en todo el país. Cada tonelada de mineral extraída representaba meses de trabajo en condiciones extremas, a más de 400 metros bajo tierra.`,
  ...
  },
  {
    ...
    description:
      "La inmigración cornish dejó una huella indeleble en Real del Monte. Sus técnicas mineras, arquitectura victoriana, tradiciones religiosas, deportes y gastronomía se fusionaron con la cultura mexicana creando una identidad única en el mundo.",
...
La relación entre Cornualles y Real del Monte es tan especial que en 2008, el gobierno británico designó a Real del Monte como parte de la "Cornish Mining World Heritage Site", el único lugar fuera de Gran Bretaña con esta distinción.`,
  ...
  },
  {
    ...
    description:
      "Las calles empedradas, casas con techos de teja roja, balcones de madera tallada, jardines florales y fachadas coloridas crean un ambiente que transporta al visitante al siglo XIX. El Centro Histórico está protegido por el INAH.",
...
El INAH ha catalogado más de 200 edificios como patrimonio histórico, y la mayoría han sido restaurados respetando técnicas originales y materiales tradicionales.`,
  ...
  },
  {
    ...
    description:
      "Ubicado a 2,700 metros sobre el nivel del mar, Real del Monte está envuelto en bosque de oyamel y pino. La neblina que frecuentemente cubre el pueblo ha inspirado poetas, pintores y leyendas durante siglos.",
...
const historicalFigures = [
  {
    ...
    period: "1881-1911",
    description:
      "Richard Bell Guest, el clown inglés que revolucionó el entretenimiento en México Porfiriano. Su personaje 'El Huácaro' hizo reír incluso al General Porfirio Díaz.",
    contribution:
      "Fundó el Gran Circo Bell y democratizó la risa en una época de represión. Su leyenda persiste en la tumba 55 del Panteón Inglés.",
  },
  {
    ...
    period: "1824-1860",
    description:
      "Conde de Regla y visionario empresario que modernizó la minería realmontense. Invirtió millones de pesos en tecnología de punta y mejoró las condiciones de los mineros.",
    contribution:
      'Introdujo el sistema de "patentado" para distribuir ganancias entre los trabajadores',
  },
  {
    name: "John Rule",
    role: "Ingeniero Jefe",
    period: "1824-1835",
    description:
      "Ingeniero de Cornualles contratado para modernizar las operaciones mineras. Diseñó el sistema de drenaje más avanzado de América.",
  ...
  },
  {
    ...
    period: "1863-1925",
    description:
      "Nacido en Real del Monte, se convirtió en figura política nacional. Escribió extensamente sobre la historia minera de su pueblo natal.",
  ...
  },
  {
    ...
    period: "1850-1880",
    description:
      "Sacerdote anglicano que sirvió a la comunidad cornish durante 30 años. Fundó la escuela bilingüe y el coro de la iglesia.",
    ...
    <RDMLayout>
      <div ref={containerRef} className="min-h-screen bg-background overflow-x-hidden">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4 md:px-8">
              ...
              >
                ...
                >
                  Más de cuatro siglos de historia minera, donde la plata forjó no solo metales
                  preciosos, sino una cultura única que fusiona lo mexicano con lo cornish. Un
                  testimonio viviente del encuentro entre dos mundos.
                </motion.p>
              ...
              {[
                ...
                <StaggerItem key={index}>
                  <div className="text-center">
                    ...
                    <div className="text-sm text-[hsl(var(--deep-black))]/70 font-medium">
                      {stat.label}
                    </div>
                  </div>
                </StaggerItem>
                ...
                >
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? "md:text-right" : "md:text-left"}`}>
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, hsl(var(--crystal-clear)/0.9), hsl(var(--crystal-glow)/0.8))",
                        border: "1px solid hsl(var(--crystal-border)/0.6)",
                        boxShadow:
                          "0 10px 40px hsl(var(--crystal-glow)/0.3), inset 0 0 30px hsl(var(--crystal-clear)/0.4)",
                    ...
                    >
                      ...
                      <p className="text-xs text-[hsl(var(--deep-black))/0.7] leading-relaxed border-t border-[hsl(var(--crystal-border)/0.4)] pt-3">
                        {item.details}
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      boxShadow:
                        "0 0 30px hsl(var(--crystal-glow)/0.5), inset 0 0 15px hsl(var(--crystal-glow)/0.3)",
                    }}
                  >
                    <div
        ...
        <section
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at center top, hsl(var(--crystal-glow)/0.1), transparent 70%)",
          }}
        >
          <div className="container mx-auto px-4 md:px-8">
            <motion.div
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, hsl(var(--crystal-clear)/0.7), hsl(var(--crystal-glow)/0.5))",
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 ml-13">
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    <strong className="text-foreground">Inglaterra, 1858.</strong> El humo
                    industrial de Deptford asfixiaba los pulmones del proletariado victoriano. En
                    este vientre de hollín nació Richard Bell Guest, hijo de James Bell, un clown
                    itinerante escocés, y Emilia Guest, de sangre irlandesa.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    Debutó a los dos años en Lyon, Francia. A lomos del Circo Chiarini en 1861,
                    recorrió una Europa fragmentada. La Inglaterra de la Revolución Industrial era
                    una maquinaria devoradora de almas. Para la élite británica, el payaso no era un
                    artista; era un bufón despreciable.
                  </p>
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 ml-13">
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Bell no fue un payaso convencional. Descartó la estridencia del clown rojo para
                    abrazar al Pierrot melancólico. Se maquilló de blanco espectral, vistió el traje
                    holgado y nació el <em>"huácaro"</em>. Su comedia no era de pastelazos, sino de
                    crítica social fin��sima.
                  </p>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Con el Circo Orrín, Bell se convirtió en una deidad popular.{" "}
                    <strong>Juan de Dios Peza</strong>, en <em>El Monitor Republicano</em>,
                    sentenció: <em>"Es más popular que el pulque"</em>. Llenaba plazas enteras.
                    Incluso el <strong>General Porfirio Díaz</strong>, un hombre de semblante
                    pétreo, acudía a su palco solo para doblegarse ante la risa.
                  </p>
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 ml-13 border-amber-500/30">
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Las giras del Circo Orrín lo llevarán a tocar la <strong>Comarca Minera</strong>
                    : Pachuca y, finalmente, Real del Monte. El choque fue brutal. Bell no encontró
                    nopales y desierto, sino un <em>"Little Cornwall"</em> incrustado en la sierra.
                  </p>
                  <blockquote className="border-l-4 border-amber-500 pl-4 my-6 italic text-foreground/80">
                    "Bell, embriagado por este sincretismo y acogido por la calidez ruda de los
                    mineros, subió al Panteón Inglés. Allí, mirando las lápidas devotas al este,
                    escupió su rebeldía. Compró un espacio por adelantado y juró:{" "}
                    <em>
                      'Cuando la muerte me alcance, entiérrenme dándole la espalda al país que me
                      escupió'
                    </em>
                    ."
                  </blockquote>
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 ml-13 bg-red-950/10 border-red-500/30">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Con el estallido de la Revolución Maderista en 1911, Bell huyó con su familia
                    hacia Nueva York. Una tormenta de nieve empeoró su condición de salud. El
                    domingo <strong>12 de marzo de 1911</strong>, a los 53 años, Ricardo Bell exhaló
                    su último aliento. Fue sepultado en Nueva York. Su propia hija, Sylvia Bell, lo
                    confirmó en su libro biográfico de 1984.
                  </p>
                  <div
                    className="p-4 rounded-lg mb-4"
                    style={{
                      background:
                        "linear-gradient(135deg, hsl(var(--crystal-clear)/0.8), hsl(var(--crystal-glow)/0.6))",
                      border: "1px solid hsl(var(--crystal-border)/0.5)",
                      boxShadow:
                        "0 5px 20px hsl(var(--crystal-glow)/0.2), inset 0 0 20px hsl(var(--crystal-clear)/0.3)",
                    }}
                  >
                    <h4 className="font-bold text-[hsl(var(--deep-black))] mb-2">
                      El Enigma Resuelto:
                    </h4>
                    <p className="text-sm text-[hsl(var(--deep-black))/0.8]">
                      La <strong>tumba 55</strong> pertenece en realidad a un minero británico
                      llamado <strong>Richard Bell</strong>, originario de Middleton, Teesdale,
                      Inglaterra. Este minero falleció el <strong>25 de octubre de 1875</strong>, a
                      los 63 años. ¿Por qué está volteada? No fue un acto de rebeldía. La historia
                      forense sugiere que un deslizamiento de tierra o un error de los sepultureros
                      locales alteró la orientación de la cantera.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 ml-13">
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Si la historia es clara, <strong>¿por qué sobrevive la leyenda?</strong> Porque
                    el pueblo de Real del Monte necesitaba que fuera verdad.
                  </p>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    La psicología colectiva hizo el resto. Fusionaron al minero anónimo con el ídolo
                    popular. Inventaron el desprecio a Inglaterra para justificar el error
                    topográfico de la tumba.
                  </p>
                  ...
                  <p className="text-sm text-muted-foreground text-center">
                    Hay quienes juran que en las madrugadas heladas se escuchan las carcajadas de
                    Bell rebotando entre los oyameles. Es la memoria viva.
                  </p>
                </div>
              </motion.div>
