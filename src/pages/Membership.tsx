  ...
  const fidelityBenefits = [
    {
      ...
      description:
        "Bonificaciones y elementos exclusivos por cumplir hitos de permanencia en la plataforma.",
    },
    {
      title: "Programa VIP",
      description:
        "Acceso anticipado a nuevas funcionalidades y contenido exclusivo para miembros de larga duración.",
    },
    {
        ...
        <div className="space-y-8">
          ...
          <section className="text-center space-y-4 relative">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight relative">
              <span className="text-gradient bg-gradient-crystal animate-text-shimmer">
                Membresía
              </span>{" "}
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Elige el nivel que mejor se adapte a tus necesidades en nuestra plataforma
              multisensorial
            </p>
          ...
          <section className="mt-16">
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground mt-2">
                El sistema reconoce y premia la lealtad de los usuarios a través de un programa de
                fidelidad progresivo
              </p>
            </div>
          ...
          <section className="mt-16 bg-black/30 backdrop-blur-md rounded-xl p-6 border border-white/10">
            <h2 className="text-2xl font-bold mb-6 text-center">
              Preguntas Frecuentes sobre Membresías
            </h2>

            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-crystal-400">
                  ¿Puedo cambiar mi plan en cualquier momento?
                </h3>
                <p className="text-sm text-muted-foreground">
                  Sí, puedes actualizar o reducir tu plan en cualquier momento. Los cambios se
                  aplicarán al comienzo del siguiente período de facturación.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Aceptamos tarjetas de crédito/débito principales, Google Pay y otros métodos de
                  pago globales para la compra de membresías o Créditos TAMV.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Sí, ofrecemos descuentos para los usuarios que eligen suscribirse anualmente. Por
                  lo general, obtienes dos meses gratis al elegir el plan anual.
                </p>
              </div>
            </div>
          </section>
