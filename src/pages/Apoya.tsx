...
const Apoya = () => {
  ...
  const handleDonate = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Error al procesar la donación.",
        variant: "destructive",
      });
      setLoading(false);
    }
              ...
              {[
                {
                  ...
                  desc: "Apoyas el turismo local y la economía de Real del Monte",
                  color: "text-primary",
                },
                {
                  icon: Star,
                  title: "Plataforma Mejor",
                  desc: "Tu apoyo nos permite mejorar funcionalidades y contenido",
                  color: "text-primary",
                },
                {
                  icon: Zap,
                  title: "Reconocimiento",
                  desc: "Aparece en nuestro muro de agradecimientos",
                  color: "text-primary",
                },
              ].map((item) => (
            ...
            <Card className="max-w-lg mx-auto border-0 shadow-2xl">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={donationType}
                    onValueChange={(v) => setDonationType(v as "app" | "business")}
                ...
                {!isAuthenticated && (
                  <div className="bg-muted border border-border rounded-lg p-4 text-sm text-muted-foreground">
                    ...
                    <a href="/auth" className="underline font-semibold text-primary">
                      iniciar sesión
                    </a>
                  </div>
                )}
